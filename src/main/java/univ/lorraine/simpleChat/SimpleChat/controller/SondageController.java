...
public class SondageController {
    ...
    /**
   	 ...
   	 * @return Une reponse
   	 */
   	public ResponseEntity createSondage(String question, String groupe_id)
   	{
   		try {
       		...
       		//this.groupeService.create(groupeName, isPrivateChat); 
       		//Groupe groupe = this.groupeService.create(question, isVotesAnonymes); 
       		...
       		Sondage sondage = this.sondageService.create(question, groupe_id);
   	...
   	{
   		return this.createSondage(sondageTemplate.getQuestion(), "1"); 
   	}
